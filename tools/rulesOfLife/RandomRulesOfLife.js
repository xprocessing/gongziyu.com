...
fetch("http://gongziyu.com/neo/RulesOfLife/RulesOfLife.json").then(function (response) {
    ...
    htmltext = '<a href="http://gongziyu.com/neo/RulesOfLife/RulesOfLife.php" target="blank">' + RandomRule + '</a>';
